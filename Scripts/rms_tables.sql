...
CREATE TABLE `tables` (
  ...
  `LocationIdentifier` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `Status` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `BranchId` int DEFAULT NULL,
  PRIMARY KEY (`TableId`),
  KEY `BranchId` (`BranchId`),
  CONSTRAINT `tables_ibfk_1` FOREIGN KEY (`BranchId`) REFERENCES `branches` (`BranchId`)
